...
def _draw(surface, cfg, tach_lit, fuel_lit, ce_on=False, lf_on=False):
    ...
    render.dim_fuel(surface, fuel_lit,
                    layout.FUEL_5H_DIM_LEFT, layout.FUEL_5H_DIM_TOP,
                    layout.FUEL_5H_DIM_RIGHT, layout.FUEL_5H_DIM_BOTTOM, cfg.dim_opacity)
    render.dim_fuel(surface, fuel_lit,
                    layout.FUEL_7D_DIM_LEFT, layout.FUEL_7D_DIM_TOP,
                    layout.FUEL_7D_DIM_RIGHT, layout.FUEL_7D_DIM_BOTTOM, cfg.dim_opacity)
    render.dim_fuel(surface, fuel_lit,
                    layout.FUEL_FABLE_DIM_LEFT, layout.FUEL_FABLE_DIM_TOP,
                    layout.FUEL_FABLE_DIM_RIGHT, layout.FUEL_FABLE_DIM_BOTTOM, cfg.dim_opacity)
